...
<span class="icon icon-mobile"></span>+36 65984 405<br/>-->
                            <span class="icon icon-envelop"></span> <a href="#">ottawalookbook@gmail.com</a> <br />
...
<span class="icon icon-facebook"></span> <a href="#">Infinity Agency</a> <br/>-->
                    ...
                    <div class="col-md-8 fade-up">
                        ...
                        <form method="post" id="contactform" action="<?php echo htmlspecialchars($_SERVER[" PHP_SELF"]);?>">
                            ...
                            <input type="email" id="email" name="email" placeholder="Email*" value="" size="4"><span class="error">
                                <?php echo $emailErr;?></span>

                            <input type="name" id="name" name="name" placeholder="Name*" value=""><span class="error">
                                <?php echo $nameErr;?></span>

                            <input type="title" id="name" name="title" placeholder="Title*" value=""><span class="error">
